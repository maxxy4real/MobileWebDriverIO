...
class HtmlReporter extends events.EventEmitter {
  constructor (baseReporter, config, options = {}) {
    ...
    this.results = {}
    this.options = {
      reportTitle:(this.config.reporterOptions.htmlFormat.reportTitle) ? this.config.reporterOptions.htmlFormat.reportTitle : 'Project Report'
    }
  ...
  htmlOutput() {
    ...
    const data = {stats: this.baseReporter.stats, title: this.options.reportTitle}
